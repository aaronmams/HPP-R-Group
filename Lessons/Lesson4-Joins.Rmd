...
This lessons covers how to join different data sets in R. An important disclaimer is that this will not be a very general discussion of how to join dataframes in R. I will be using the [dplyr package](https://dplyr.tidyverse.org/) and `dplyr` syntax to do all of the joins. I can offer two arguments for it's worth focusing this lesson on the `dplyr` way of doing joins:
