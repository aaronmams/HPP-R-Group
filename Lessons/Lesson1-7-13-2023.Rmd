...
```{r}
soquel <- read.csv(file="C:/Users/aaron.mamula/Desktop/R-Projects/HPP-R-Course-2023/Data/SoquelCreek.csv")
...
was different from the directory where the file is stored, ```C:/Users/aaron.mamula/Desktop/R-Projects/HPP-R-Course-2023/Data```.

An alternative way to do this would be to change R's working directory to be the directory where the file is stored:

```{r}
setwd("C:/Users/aaron.mamula/Desktop/R-Projects/HPP-R-Course-2023/Data")
