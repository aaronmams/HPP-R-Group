...
For this application I used the same USGS data for Soquel Creek but I downloaded daily stream discharge measurements from 1990 to June 2023. You can download the .csv file that I'm working [from the Data subdirectory of the HPP-R-Group-2023 GitHub page](https://github.com/aaronmams/HPP-R-Group-2023).
