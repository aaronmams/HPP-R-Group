...
* [A tutorial I wrote for another class on data types and structures in R](https://github.com/aaronmams/rHD-Data-Wrangling/blob/master/Data-Types-and-Structures.Rmd)

    * It's kind of long but it has lots of code that you can use to familiarize yourself with data structures in R. It's also formatted as an R Markdown file which may be an unfamiliar file type to some of you at this point.
...
![Soquel Creek.](C:/Users/aaron.mamula/Desktop/R-Projects/HPP-R-Group-2023/figures/soquel_creek.jpg)
...
For this application I used the same USGS data for Soquel Creek but I downloaded daily stream discharge measurements from 1990 to June 2023.


### Step 1: Get the Data

The first step in this process is to go into the [Data folder in the google drive](https://drive.google.com/drive/folders/14lwS7pfRmr3eEpAlmFCFLfcbFWEDYF7w?usp=drive_link) and copy the ```SoquelCreek.csv``` file somewhere to your computer. 
...
```{r}
soquel <- read.csv(file="C:/Users/aaron.mamula/Desktop/R-Projects/HPP-R-Group-2023/Data/SoquelCreek.csv")
...
In this case, the ```str()``` function tells us that the object ```soquel``` is a ```data frame``` with 12,054 observations (rows) and 4 variable (columns). Additionally, ```str()``` tells us what kind of information is stored in each of the columns.
...
```{r}
setwd("C:/Users/aaron.mamula/Desktop/R-Projects/HPP-R-Group-2023/Data")
