...
The reason I'm doing it this way is that (i) we don't really have time to give significant attention to both base-R graphics and ```ggplot2``` graphics and (ii) I don't use base-R for data visuals. I can't teach what I don't use.
...
Our data are large and inherantly seasonal. One way we might want to visualize the seasonal patterns of stream flow might be with a boxplot. Here is an example:
