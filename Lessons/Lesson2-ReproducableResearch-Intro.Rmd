...
In Lesson 1 we kind of jumped right into *How to use R* without too much discussion of *Why would you want to?*. This Lesson gives an introduction to one of the resasons that R has become popular among data analysts and scientists: Reproducable Research.

This lesson focuses on a single task that is an important element of Reproducable Research: constructing an R Script. 
...
This part will be much easier to demonstrated during class time but I'll do my best to provide a ste-by-step here. 

## Step 1: Open a Script

> File --> New File --> R Script

```{r out.width="75%", fig.cap="Step 1: Open a Script."}
...
```{r out.width="75%", fig.cap="Step 1 Result"}
...
```{r out.width="75%",fig.cap="Step 2: Populate the Script}
...
```{r out.width="75%",fig.cap="Step 3: Execute the Script"}
